...
@pytest.fixture(scope='module')
def node_operator_registry(deployer, node_operator, DummyNodeOperatorsRegistry):
    return DummyNodeOperatorsRegistry.deploy(node_operator, '0x00000000219ab540356cBB839Cbe05303d7705Fa', {'from': deployer})
...
@pytest.fixture(scope='module')
def node_operator_contracts(deployer, node_operator, NaiveNOR, SimpleBatchNOR, MerkleNOR, MerkleBatchNOR):
    return NodeOperatorContracts(deployer, node_operator, '0x00000000219ab540356cBB839Cbe05303d7705Fa', NaiveNOR, SimpleBatchNOR, MerkleNOR, MerkleBatchNOR)
